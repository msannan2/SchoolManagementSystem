...
namespace DataBindingDemo
 {
    ...
    public partial class Studenttemp : IBaseEntity
    {
      ...
      /*  public List<string> GenderType
        {
            get { return m_genderList; }
            set { m_genderList = value; NotifyPropertyChanged("GenderType"); }
        }
     */
        ...
        public Studenttemp()
        {
            m_genderList = new List<string> {"Male","Female"};
        }
	}
}